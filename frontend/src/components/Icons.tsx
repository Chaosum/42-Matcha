...
export function SkipIcon() {
  return (
    <Icon aria-label="Skip" className={"user-icon"}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
...
export function UserIcon({
  ...
  return (
    <Icon aria-label="user icon" className={className}>
      {children}
    </Icon>
  );
}
...
export function ProfileIcon() {
  return (
    <Icon aria-label="Profile" className={"user-icon"}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export function ChatOptionIcon() {
  return (
    <Icon aria-label={"Chat Option"} className={"user-icon"}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export function ConversationIcon() {
  return (
    <Icon aria-label={"Chat"} className={"user-icon"}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export function UploadIcon() {
  return (
    <Icon aria-label={"Upload"} className={"user-icon"}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export function DefaultAvatar() {
  return (
    <Icon aria-label={"Default icon"} className={"user-icon"}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
